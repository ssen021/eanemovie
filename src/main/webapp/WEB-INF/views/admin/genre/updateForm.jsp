...
<div id="wrapper">
    ...
    <div class="container-fluid">
        ...
        <div class="card shadow mb-4">
            <form method="post" action="/csmovie/admin/genres/${genre.id}/edit" enctype="multipart/form-data">
                <div class="card-header py-3">
                    <h4 class="m-0 font-weight-bold text-primary"><i class="fas fa-compact-disc"> Genre</i>
                        <a href='#' class="btn btn-primary float-right" onclick="location.href='/csmovie/admin/genres/${genre.id}'"><i class="fas fa-undo"></i></a>
