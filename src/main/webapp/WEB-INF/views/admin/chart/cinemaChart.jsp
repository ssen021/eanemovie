...
<div id="wrapper">
    ...
    <div class="container-fluid">
        ...
        <!-- Page Heading -->
        <h1 class="h3 mb-2 text-gray-800">월간 매출 (영화관)</h1>
                    ...
                    <div class="card-body">
                        <table class="table table-bordered table-striped">
                            <tr>
                                ...
                                <th scope="row" width="20%" style="vertical-align:middle;">극장</th>
                                <td width="30%">
                                    <select class="form-control" onchange="changeChart()" name="cinemaId" id="select2">
...
<script>
    ...
    function chart(cinemaId, year) {
        $(function() {
            $.ajax({
                type: "post",
                url: "/csmovie/admin/chart/cinema",
                data: {
                    cinemaId: cinemaId,
                    year: year
                },
    ...
    function changeChart() {
        ...
        let cinemaId = $('select[name=cinemaId]').val();
