...
<div id="wrapper">
    ...
    <div class="container-fluid">
        ...
        <div class="card shadow mb-4">
            <form method="post" action="/csmovie/admin/members/add" enctype="multipart/form-data">
                    ...
                    <table class="table table-bordered table-striped">
                        ...
                        <tr>
                            ...
                            <spring:bind path="member.name">
                                ...
                                <td width="80%">
                                    <input type="text" class="form-control" name="${status.expression}" value="${status.value}" class="form-control" id="${status.expression}" placeholder="이름을 입력해주세요">
                        ...
                        <tr>
                            <spring:bind path="member.password">
                                ...
                                <td width="80%">
                                    <input type="text" name="${status.expression}" id="${status.expression}" value="${status.value}" class="form-control"  placeholder="비밀번호를 입력해주세요">
                                        ${status.errorMessage }
                                </td>
                            </spring:bind>
                        </tr>
                        <tr>
                            <spring:bind path="member.address">
                                ...
                                <td width="80%">
                                    <input type="text" name="${status.expression}" id="${status.expression}" value="${status.value}" class="form-control"  placeholder="주소를 입력해주세요">
                                        ${status.errorMessage }
                                </td>
                            </spring:bind>
                        </tr>
