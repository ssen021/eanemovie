...
<div id="wrapper">
    ...
    <div class="container-fluid">
        ...
        <div class="card shadow mb-4">
            <form name="updateForm" action="/csmovie/admin/directors/${director.id}/edit" method="GET">
            </form>
            <form name="deleteForm" action="/csmovie/admin/directors/${director.id}/delete" method="GET">
            </form>
            <div class="card-header py-3">
                <h4 class="m-0 font-weight-bold text-primary"><i class="fas fa-user"> Director</i>
                    <a href='#' class="btn btn-primary float-right" onclick="location.href='/csmovie/admin/directors'"><i class="fas fa-undo"></i></a>
