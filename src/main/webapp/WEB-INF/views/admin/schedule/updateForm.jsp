...
<div id="wrapper">
    ...
    <div class="container-fluid">
        ...
        <div class="card shadow mb-4">
            <form method="post" action="/csmovie/admin/schedules/update/${schedule.id}">
                <div class="card-header py-3">
                    <h4 class="m-0 font-weight-bold text-primary"><i class="fas fa-calendar-week"><a href="/csmovie/admin/schedules" style="text-decoration:none"> Schedule</a></i>
                        <a href='#' class="btn btn-primary float-right" onclick="location.href='/csmovie/admin/schedules/${schedule.id}'"><i class="fas fa-undo"></i></a>
                    ...
                    <table class="table table-bordered table-striped">
                        ...
                        <tr>
                            <spring:bind path="schedule.screening_date">
                                ...
                                <td width="80%">
                                    <input type="text" autocomplete="off" id="datePicker" value="${schedule.screening_date}"
                        ...
                        <tr>
                            <spring:bind path="schedule.screening_format">
                                ...
                                <td width="80%">
                                    <input type="text" class="form-control" name="${status.expression }" value="${schedule.screening_format}"
