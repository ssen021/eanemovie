...
<div id="wrapper">
    ...
    <div class="container-fluid">
        ...
        <div class="card shadow mb-4">
            <form method="post" action="/csmovie/admin/movie_actors/${movieActorForm.id}/edit" enctype="multipart/form-data">
                <div class="card-header py-3">
                    <h4 class="m-0 font-weight-bold text-primary"><i class="fas fa-users"> Movie Actor</i>
                        <a href='#' class="btn btn-primary float-right" onclick="location.href='/csmovie/admin/movie_actors/${movieActorForm.id}'"><i class="fas fa-undo"></i></a>
                ...
                <div class="card-body">
                    <table class="table table-bordered table-striped">
                        ...
                        <tr>
                            ...
                            <td width="80%">
                                <input type="text" class="form-control" name="id" id="id" value="${movieActorForm.id}"  readonly>
                            </td>
                        </tr>
                        <tr>
